...
namespace LTP2_NparaN.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProduto,NomeProduto")] Produtos produtos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProduto,NomeProduto")] Produtos produtos)
        {
            if (ModelState.IsValid)
            {
