<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Endereco2.aspx.cs" Inherits="Servidor_Email.Endereco2" %>
    ...
    <div class="container">
        ...
        <form id="form1" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <asp:DropDownList ID="ddl_Estados" runat="server" CssClass="form-control" 
                        OnSelectedIndexChanged="ddl_Estados_SelectedIndexChanged"
                         AutoPostBack="true">
                    </asp:DropDownList>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-6">
                    <asp:DropDownList ID="ddl_Cidades" runat="server" CssClass="form-control">
                    </asp:DropDownList>
                </div>
            </div>
